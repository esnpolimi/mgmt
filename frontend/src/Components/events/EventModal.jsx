...
export default function EventModal({ open, event, isEdit, onClose }) {
        ...
        return (
            <Box my={2}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                    Dati anagrafici memorizzati nel database e visualizzati nelle liste.
                    {formFieldsDisabled ? "Campi non modificabili (iscrizioni presenti)." : ""}
                </Typography>
                <Select
                    multiple
                    variant="outlined"
    ...
    /* Form block */
    const FormBlock = function FormBlock({ dataRef, errorsRef, hasSubscriptions }) {
            ...
            <Box sx={style} component="form" onSubmit={handleSubmit} noValidate={false}>
                {isLoading ? <Loader /> : (
                    <>
                        ...
                        <ProfileData dataRef={dataRef} formFieldsDisabled={false} />
                        <AdditionalFields dataRef={dataRef} isEdit={isEdit} hasSubscriptions={hasSubscriptions} />
                        <FormBlock dataRef={dataRef} errorsRef={errorsRef} />
